  ...
  return (
    <div className="settings">
      <div className="settings__wrapper">
        <h2 className="settings__title">Registration</h2>

        <div className="settings__top">
          {/* <button className="setting__btn"> Login </button> */}
          <button className="setting__btn active__btn">User Registration </button>
          <button className="setting__btn">Owner Registration</button>
